...
function scangamepads() {
  ...
  for (var i = 0; i < gamepad.length; i++) {
    if (gamepad[i]) {
      ...
      clearInterval(interval);      //stop polling for new gamepads once one is found. this may be problamatic right now considering above code structure is for multiple pads.
    }
  }
}
